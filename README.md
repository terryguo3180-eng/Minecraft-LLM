...
If you don't have a Python environment or just want to get started quickly, you can download the pre-generated datapack `stories260K.zip` from this repo and skip to step 3. Note that this datapack does not support chatting (generated from [this](https://huggingface.co/karpathy/tinyllamas/tree/main/stories260K) model in llama2.c)
