...
Example conversation with the 15M model (~24 hours):
<img width="2262" height="528" alt="image" src="https://github.com/user-attachments/assets/d91dc8d5-d0f3-4190-8000-42b10768f58d" />

Example story generated by the 260K model (~1 hour):
...
### 5. Run the Model
After entering the world, run `/reload` once, and execute `/gamerule max_command_sequence_length 2147483647`.
...
```mcfunction
/function <pack>:setup
/function <pack>:chat {t:10,i:"Hello, how are you?"}
# Wait for several hours
/function <pack>:chat {t:10,i:"What have you been up to lately?"}
# Wait for several more hours
```
